    ...
    <div className="App">
     <div className="maincontainer">
        <div id="preloder">
            ...
            <li><a href="#">Kid's and Baby's</a></li>
            ...
            <p>Fashion styles are constantly evolving, but there are certain trends that appear over and over again on runways and in street style.Learn more about the different types of fashion styles that influence popular fashion trends, and find your own personal style.</p>
            <a href="#">Shop now</a>
            </div>
            </div>
            </div>
            ...
            <div class="product__price">Rs. 1059.0</div>
            </div>
            </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mix">
            ...
            <div class="product__price">Rs. 2349.0</div>
            </div>
            </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mix">
            ...
            <div class="product__price">Rs. 1259.0</div>
            </div>
            </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mix">
            ...
            <div class="product__price">Rs. 1559.0</div>
            </div>
            </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mix">
            ...
            <div class="product__price">Rs. 2359.0</div>
            </div>
            </div>
            </div>
            ...
            <div class="product__price">Rs.1449.00</div>
            </div>
            </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
            ...
            <div class="product__price">Rs. 2459.0</div>
            </div>
            </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
            ...
            <div class="product__price">Rs. 4569.00</div>
            </div>
            </div>
            </div>
            </div>
            ...
            <p>Copyright 2021 &copy; <script>document.write(new Date().getFullYear());</script> Weerasinghe Textile. All rights reserved </p>
            </div>
